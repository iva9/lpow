  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function Y5(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoginPage = /*#__PURE__*/function () {
        function LoginPage(afauth, alertController, router, user, google, firestore, afdatabase) {
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 8:
                      ...
                      if (!(_context.t0.code == "auth/invalid-password")) {
                        _context.next = 12;
                        break;
                      }

                      return _context.abrupt("return", this.showalert("Erro", "Senha errada"));
                    ...
                    case 12:
                      ...
                      return _context.abrupt("return", this.showalert("Erro", "Usuario não encontrado."));

                    case 16:
                      return _context.abrupt("return", this.showalert(_context.t0.code, _context.t0.message));
              ...
              return regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 2:
                      foi = _context3.sent.emailVerified;
                      console.log(foi);
    ...
    function PG(module, __webpack_exports__, __webpack_require__) {
      ...
      var ProximoEventoPageRoutingModule = function ProximoEventoPageRoutingModule() {
    ...
    function AClZ(module, __webpack_exports__, __webpack_require__) {
      ...
      var EventoPesquisaPageRoutingModule = function EventoPesquisaPageRoutingModule() {
    ...
    function CM9R(module, __webpack_exports__, __webpack_require__) {
      ...
      var EventomodalPageRoutingModule = function EventomodalPageRoutingModule() {
    ...
    function D9P7(module, __webpack_exports__, __webpack_require__) {
      ...
      var UsuarioPesquisaPageRoutingModule = function UsuarioPesquisaPageRoutingModule() {
    ...
    function I6jx(module, __webpack_exports__, __webpack_require__) {
      ...
      var NovoEventoPageModule = function NovoEventoPageModule() {
    ...
    function JBpm(module, __webpack_exports__, __webpack_require__) {
      ...
      var EventomodalPageModule = function EventomodalPageModule() {
    ...
    function RFKi(module, __webpack_exports__, __webpack_require__) {
      ...
      var EditarModalPageRoutingModule = function EditarModalPageRoutingModule() {
    ...
    function Sy1n(module, __webpack_exports__, __webpack_require__) {
      ...
      AppComponent.ctorParameters = function () {
        return [{
          type: _home_home_page__WEBPACK_IMPORTED_MODULE_9__["HomePage"]
        }, {
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_home_home_page__WEBPACK_IMPORTED_MODULE_9__["HomePage"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["Platform"], _angular_fire_auth__WEBPACK_IMPORTED_MODULE_8__["AngularFireAuth"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_5__["SplashScreen"], _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ToastController"], _ionic_native_network_ngx__WEBPACK_IMPORTED_MODULE_7__["Network"]])], AppComponent);
      /***/
    },
    ...
    function VGZ(module, __webpack_exports__, __webpack_require__) {
      ...
      var EventoPesquisaPageModule = function EventoPesquisaPageModule() {
    ...
    function ZAI4(module, __webpack_exports__, __webpack_require__) {
      ...
      var AppModule = AppModule_1 = function AppModule(injector) {
    ...
    function b0Dx(module, __webpack_exports__, __webpack_require__) {
      ...
      var NovoEventoPageRoutingModule = function NovoEventoPageRoutingModule() {
                ...
                while (1) {
                  switch (_context27.prev = _context27.next) {
                    case 0:
                      ...
                      this.loadingC.dismiss();
                      return _context27.abrupt("return", this.showalert("Erro", "insira nome de usuario"));
                    ...
                    case 9:
                      ...
                      this.loadingC.dismiss();
                      return _context27.abrupt("return", this.showalert("Erro", "nome ja existente"));
                    ...
                    case 12:
                      ...
                      this.loadingC.dismiss();
                      return _context27.abrupt("return", this.showalert("Erro", "senhas diferentes"));
                    ...
                    case 27:
                      ...
                      if (!(_context27.t0.code == "auth/weak-password")) {
                        _context27.next = 32;
                        break;
                      }

                      this.loadingC.dismiss();
                      return _context27.abrupt("return", this.showalert("Senha Fraca", "Senha deve ter no mínimo 6 caracteres"));

                    case 32:
                      if (!(_context27.t0.code == "auth/invalid-email")) {
                        _context27.next = 35;
                        break;
                      }

                      this.loadingC.dismiss();
                      return _context27.abrupt("return", this.showalert("Erro", "Email invalido"));

                    case 35:
                      if (!(_context27.t0.code == "auth/email-already-in-use")) {
                        _context27.next = 38;
                        break;
                      }

                      this.loadingC.dismiss();
                      return _context27.abrupt("return", this.showalert("Erro", "Email ja em uso"));
              ...
              return regeneratorRuntime.wrap(function _callee32$(_context32) {
                while (1) {
                  switch (_context32.prev = _context32.next) {
                    ...
                    case 2:
                      _context32.sent.sendEmailVerification();
    ...
    function h1CP(module, __webpack_exports__, __webpack_require__) {
      ...
      var EditarModalPageModule = function EditarModalPageModule() {
    ...
    function nSE(module, __webpack_exports__, __webpack_require__) {
      ...
      var UsuarioPesquisaPageModule = function UsuarioPesquisaPageModule() {
    ...
    function sFwW(module, __webpack_exports__, __webpack_require__) {
      ...
      var ProximoEventoPageModule = function ProximoEventoPageModule() {
              ...
              return regeneratorRuntime.wrap(function _callee38$(_context38) {
                while (1) {
                  switch (_context38.prev = _context38.next) {
                    ...
                    case 2:
                      _context38.sent.sendEmailVerification();
                ...
                while (1) {
                  switch (_context40.prev = _context40.next) {
                    case 0:
                      ...
                      return _context40.abrupt("return", this.showalert("Erro", "nome ja existente"));
                ...
                while (1) {
                  switch (_context44.prev = _context44.next) {
                    case 0:
                      ...
                      this.jadeuUP = true;
                      return _context44.abrupt("return", this.showAlertLogin());
                    ...
                    case 6:
                      ...
                      return _context44.abrupt("return", this.showalert("Ops!", "Você ja deu UP nesse evento"));
              ...
              return regeneratorRuntime.wrap(function _callee52$(_context52) {
                while (1) {
                  switch (_context52.prev = _context52.next) {
                    ...
                    case 2:
                      res = _context52.sent.displayName;
                      this.usuario = res;
                ...
                while (1) {
                  switch (_context54.prev = _context54.next) {
                    ...
                    case 20:
                      ...
                      return _context54.abrupt("return", this.showalert("Ops!", "O Oreon só esta disponivel em Brasília, Rio de Janeiro e São paulo"));

                    case 22:
                      console.log(this.lugar);
                      return _context54.abrupt("return", (this.local, this.lugar));
                ...
                while (1) {
                  switch (_context59.prev = _context59.next) {
                    ...
                    case 3:
                      ...
                      return _context59.abrupt("return", this.showalert("Ops!", "Você ja deu UP nesse evento"));
        ...
        _createClass(HomePage, [{
          ...
          value: function showDacidade() {
            ...
            this.authh.onAuthStateChanged(function (user) {
              if (user) {
                ...
                _this54.getcidadade(uid).subscribe(function (cit) {
                  _this54.lugar = cit;

                  if (_this54.lugar) {
                    console.log(_this54.lugar);
                    _this54.cidadesDoUsuario = _this54.lugar;

                    _this54.cidadedoUSER(_this54.cidadesDoUsuario);
                ...
                if (res.emailVerified == false) {
                  ...
                  _this54.criaruserpage.showalert("Ops você já criou uma conta ", "Mas não clickou no link que enviamos, verifique e volte ");

                  _this54.login.enviaremaildeverific();
                } // ...

              } else {
                _this54.AuthstateDeslogado();
              }
            });
          }
        }, {
          ...
          value: function getcidadade(user) {
            ...
            return this.userDOC.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["map"])(function (actions) {
              return actions.map(function (use) {
                ...
                _this56.ordenarpor = order;

                if (_this56.ordenarpor == null) {
                  _this56.ordenarpor = false;
          ...
          value: function listadaciadade(x) {
            ...
            return this.eventocidade.get().subscribe(function (coisas) {
              coisas.forEach(function (b) {
                ...
                _this57.m = moment__WEBPACK_IMPORTED_MODULE_13__(data.dia).format('ddd DD MMM - HH:mm');
                data.dia = _this57.m;
                _this57.provCid1 = Object.assign({
                  id: id
                }, data);

                _this57.y.push(_this57.provCid1);

                _this57.nextQueryAfter = b;
              });
            });
          }
        }, {
          ...
          value: function listaonline() {
            ...
            return this.eventoOnline.get().subscribe(function (coisas) {
              coisas.forEach(function (o) {
                ...
                data.dia = _this58.m;
                _this58.provOnl1 = Object.assign({
                  id: id
                }, data);

                _this58.z.push(_this58.provOnl1);

                _this58.nextQueryOnline = o;
              });
            });
          }
        }, {
          ...
          value: function listanacional() {
            ...
            if (this.ordenarpor == true) {
              ...
              this.eventoNacional = this.firestore.collection('eventos', function (ref) {
                return ref.where('passado', '==', false).orderBy('dia', 'asc').limit(2);
              });
            }
            ...
            if (this.ordenarpor == false) {
              //console.log("false")
              this.eventoNacional = this.firestore.collection('eventos', function (ref) {
                return ref.where('passado', '==', false).orderBy('UPnum', 'desc').limit(2);
              });
            }
            ...
            return this.eventoNacional.get().subscribe(function (coisas) {
              coisas.forEach(function (n) {
                ...
                data.dia = _this59.m;
                _this59.provNac1 = Object.assign({
                  id: id
                }, data);

                _this59.w.push(_this59.provNac1);

                _this59.nextQuerynacional = n;
              });
            });
          }
        }, {
          ...
          value: function loadcidade(event) {
            ...
            setTimeout(function () {
              ...
              if (_this60.cidade.length >= 1) {
                _this60.eventosdacidade2 = _this60.listadaciadade2(_this60.cidadesDoUsuario);
              }
          ...
          value: function loadnacional(event) {
            ...
            setTimeout(function () {
              ...
              if (_this61.nacionais.length >= 1) {
                _this61.eventosNacional2 = _this61.listanacional2();
              }
          ...
          value: function loadOnline(event) {
            ...
            setTimeout(function () {
              ...
              if (_this62.online.length >= 1) {
                _this62.eventosOnline2 = _this62.listaonline2();
              }
          ...
          value: function listadaciadade2(x) {
            ...
            if (this.ordenarpor == true) {
              this.eventocidade = this.firestore.collection('eventos', function (ref) {
                return ref.where('lugar', '==', "".concat(x)).where('passado', '==', false).orderBy('dia', 'asc').startAfter(_this63.nextQueryAfter).limit(1);
              });
            }

            if (this.ordenarpor == false) {
              this.eventocidade = this.firestore.collection('eventos', function (ref) {
                return ref.where('lugar', '==', "".concat(x)).where('passado', '==', false).orderBy('UPnum', 'desc').startAfter(_this63.nextQueryAfter).limit(1);
              });
            }
            ...
            return this.eventocidade.get().subscribe(function (city) {
              city.forEach(function (a) {
                ...
                moment__WEBPACK_IMPORTED_MODULE_13__["locale"]('pt-BR');
                _this63.m = moment__WEBPACK_IMPORTED_MODULE_13__(data.dia).format('ddd DD MMM - HH:mm'); // passa data para o Português

                data.dia = _this63.m;
                _this63.nextQueryAfter = a; // ultimo evento para o infinite scroll

                _this63.conjunto = Object.assign({
                  id: id
                }, data);

                _this63.cidade3.push(_this63.conjunto);

                var numeros = _this63.cidade3; // concertar o bug da repetição 
                ...
                _this63.cidade3 = uniqueAddresses;
                return Object.assign({
                  id: id
                }, data);
              });
          ...
          value: function listanacional2() {
            ...
            if (this.ordenarpor == true) {
              this.eventoNacional = this.firestore.collection('eventos', function (ref) {
                return ref.where('passado', '==', false).orderBy('dia', 'asc').startAfter(_this64.nextQuerynacional).limit(1);
              });
            }

            if (this.ordenarpor == false) {
              this.eventoNacional = this.firestore.collection('eventos', function (ref) {
                return ref.where('passado', '==', false).orderBy('UPnum', 'desc').startAfter(_this64.nextQuerynacional).limit(1);
              });
            }
            ...
            return this.eventoNacional.get().subscribe(function (ncaionais2) {
              ncaionais2.forEach(function (a) {
                ...
                data.dia = _this64.m;
                _this64.nextQuerynacional = a; // ultimo evento para o infinite scroll

                _this64.conjuntoNac = Object.assign({
                  id: id
                }, data);

                _this64.nacional.push(_this64.conjuntoNac);

                var numeross = _this64.nacional; // concertar o bug da repetição 
                ...
                _this64.nacional = uniqueAddressesNac; //console.log(this.nacional)
          ...
          value: function listaonline2() {
            ...
            if (this.ordenarpor == true) {
              this.eventoOnline = this.firestore.collection('eventos', function (ref) {
                return ref.where('online', '==', 'online').where('passado', '==', false).orderBy('dia', 'asc').startAfter(_this65.nextQueryOnline).limit(1);
              });
            }

            if (this.ordenarpor == false) {
              this.eventoOnline = this.firestore.collection('eventos', function (ref) {
                return ref.where('online', '==', 'online').where('passado', '==', false).orderBy('UPnum', 'desc').startAfter(_this65.nextQueryOnline).limit(1);
              });
            }
            ...
            return this.eventoOnline.get().subscribe(function (onlines) {
              onlines.forEach(function (t) {
                ...
                data.dia = _this65.m;
                _this65.nextQueryOnline = t; // ultimo evento para o infinite scroll

                _this65.conjuntoOnl = Object.assign({
                  id: id
                }, data);

                _this65.onlines.push(_this65.conjuntoOnl);

                var nume = _this65.onlines; // concertar o bug da repetição 
                ...
                _this65.onlines = uniqueAddressesOnl;
                return Object.assign({
                  id: id
                }, data);
              });
