(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["share-share-module"], {
    ...
    /***/
    function ADsi(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var SharePageModule = /*#__PURE__*/_createClass(function SharePageModule() {
    ...
    /***/
    function cUFh(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function iTT4(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function u5XX(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_share_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./share.page.html */
      "cUFh");
      /* harmony import */


      var _share_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./share.page.scss */
      "iTT4");
      /* harmony import */
      ...
      var SharePage = /*#__PURE__*/function () {
        function SharePage(screenshot, sharing, route, firestore) {
        ...
        _createClass(SharePage, [{
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 2:
                      ...
                      _context.t0 != null;
                      this.screenshot.URI(100).then(function (res) {
          ...
          value: function getevento() {
            ...
            this.evento = this.firestore.collection('eventos', function (ref) {
              return ref.where('chave2', '==', "".concat(_this2.eventoID));
            }); // Firestore evento

            return this.evento.get().subscribe(function (b) {
              b.forEach(function (com) {
                var val = com.data();
                moment__WEBPACK_IMPORTED_MODULE_8__["locale"]('pt-BR');
                _this2.m = moment__WEBPACK_IMPORTED_MODULE_8__(val.dia).format('ddd DD MMM - HH:mm');
                val.dia = _this2.m;
                _this2.x = val;
              });
            });
          ...
          key: "shareInstagram",
          value: function shareInstagram() {
            var _this3 = this;

            setTimeout(function () {
              _this3.screenShotURI();
            }, 3000);
            this.aparecer = true; // 2 arguments
          ...
          key: "shareWatsapp",
          value: function shareWatsapp() {
            var _this5 = this;

            setTimeout(function () {
              _this5.screenShotURI();
            }, 3000);
            this.aparecer = true;
      ...
      SharePage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        selector: 'app-share',
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_native_screenshot_ngx__WEBPACK_IMPORTED_MODULE_6__["Screenshot"], _ionic_native_social_sharing_ngx__WEBPACK_IMPORTED_MODULE_7__["SocialSharing"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_4__["AngularFirestore"]])], SharePage);
      /***/
    },
    ...
    /***/
    function uxXr(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var SharePageRoutingModule = /*#__PURE__*/_createClass(function SharePageRoutingModule() {
