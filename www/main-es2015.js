...
let PesquisarPage = class PesquisarPage {
    ...
    initializeitems() {
        const eventoslist = this.firestore.collection('eventos').valueChanges().pipe((Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["first"])())).toPromise();
        return eventoslist;
    }
    filterlist(evt) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
