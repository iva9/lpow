...
const writeNavState = /*#__PURE__*/function () {
  var _ref = (0,_Users_ivanovmachadodossantos_Documents_OreonIos_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (root, chain, direction, index, changed = false, animation) {
    try {
...
const readNavState = /*#__PURE__*/function () {
  var _ref2 = (0,_Users_ivanovmachadodossantos_Documents_OreonIos_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* (root) {
    const ids = [];
    let outlet;
