...
export declare class Item extends Ion {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<Item, [null, null, null, null, { optional: true; }]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<Item, "ion-list-header,ion-item,[ion-item],ion-item-divider", never, {}, {}, ["contentLabel", "_buttons", "_icons"], ["[item-start],[item-left],ion-checkbox:not([item-end]):not([item-right])", "ion-label", "*", "ion-select,ion-input,ion-textarea,ion-datetime,ion-range,[item-content]", "[item-end],[item-right],ion-radio,ion-toggle"]>;
}
