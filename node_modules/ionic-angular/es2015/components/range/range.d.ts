...
export declare class Range extends BaseInput<any> implements AfterContentInit, ControlValueAccessor, OnDestroy {
     ...
     */
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<Range, [null, null, { optional: true; }, null, null, null, null, null, null]>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<Range, "ion-range", never, { "min": "min"; "max": "max"; "step": "step"; "snaps": "snaps"; "pin": "pin"; "debounce": "debounce"; "dualKnobs": "dualKnobs"; }, {}, never, ["[range-left]", "[range-right]"]>;
}
