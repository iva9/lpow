...
import * as ɵngcc3 from '../../tap-click/haptic';
...
function PickerColumnCmp_button_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function PickerColumnCmp_button_3_Template_button_click_0_listener($event) { const restoredCtx = ɵngcc0.ɵɵrestoreView(_r7); const i_r5 = restoredCtx.index; const ctx_r6 = ɵngcc0.ɵɵnextContext(); return ctx_r6.optClick($event, i_r5); });
    ɵngcc0.ɵɵtext(1);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
PickerColumnCmp.ɵfac = function PickerColumnCmp_Factory(t) { return new (t || PickerColumnCmp)(ɵngcc0.ɵɵdirectiveInject(ɵngcc1.Config), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.Platform), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone), ɵngcc0.ɵɵdirectiveInject(ɵngcc3.Haptic), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.Platform), ɵngcc0.ɵɵdirectiveInject(ɵngcc4.DomController)); };
PickerColumnCmp.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: PickerColumnCmp, selectors: [["", 8, "picker-col"]], viewQuery: function PickerColumnCmp_Query(rf, ctx) { if (rf & 1) {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(PickerColumnCmp, [{
        type: Component,
        args: [{
                selector: '.picker-col',
    ...
    }], function () { return [{ type: ɵngcc1.Config }, { type: ɵngcc2.Platform }, { type: ɵngcc0.ElementRef }, { type: ɵngcc0.NgZone }, { type: ɵngcc3.Haptic }, { type: ɵngcc2.Platform }, { type: ɵngcc4.DomController }]; }, { ionChange: [{
            type: Output
        }], colEle: [{
            type: ViewChild,
            args: ['colEle']
