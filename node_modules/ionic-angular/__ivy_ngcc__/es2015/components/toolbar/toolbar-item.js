...
ToolbarItem.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: ToolbarItem, selectors: [["ion-buttons"], ["", "menuToggle", ""]], contentQueries: function ToolbarItem_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, Button, 0);
    } if (rf & 2) {
        let _t;
